...
<div id="media-upload-header">
	<ul id='sidemenu'>
		<li id='tab-type'><a href='bicm-media-button.php'>Search books/audio books</a></li>
		<li id='tab-type'><a href='bicm-media-button-carousel.php' class='current'>Carousel Widget</a></li>
	</ul>
</div>
	...
	<table class="describe" style="border-top: none; padding-bottom: 0"><tbody>
		<tr>
			<th valign="top" scope="row" class="label">
				<span class="alignleft"><label>ISBN numbers</label><br/> (seperated with commas)</span>
			</th>
			<td class="field"><textarea name="isbns" cols="50" rows="5" style="width: 200px"></textarea></td>
		</tr>
		<tr>
			
			<td colspan="2"><p style="text-align:center">&mdash; OR &mdash;</p></td>
		</tr>
...
<div id="media-upload-header">
	<ul id='sidemenu'>
		<li id='tab-type'><a href='#' class='current'>Preview</a></li>
	</ul>
</div>
