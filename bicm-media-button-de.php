...
<script type='text/javascript' src='js/bicmedia.de.min.js'></script>
...
<div id="media-upload-header">
	<ul id='sidemenu'>
		<li id='tab-type'><a href='bicm-media-button-de.php' class='current'>Buch/H&ouml;rbuch suchen</a></li>
		<li id='tab-type'><a href='bicm-media-button-carousel-de.php'>Karussell Widget</a></li>
	</ul>	
</div>
...
<legend>Suchparameter</legend>
	<table class="describe" style="border-top: none; padding-bottom: 0"><tbody>
		...
		<p style="text-align:center">&mdash; ODER &mdash;</p>
	

	<table class="describe" style="border-top: none; padding-top: 0"><tbody>
		<tr>
			<th valign="top" scope="row" class="label">
				<span class="alignleft"><label>B&uuml;cher</label></span>
			</th>
			<td class="field"><input type="checkbox" name="book" checked="checked" /></td>
		</tr>
		<tr>
			<th valign="top" scope="row" class="label">
				<span class="alignleft"><label>H&ouml;rb&uuml;cher</label></span>
			</th>
...
<option value="62">Verlagsgesellschaft Rudolf M&uuml;ller</option>
		...
		<tr>
			<th valign="top" scope="row" class="label">
				<span class="alignleft"><label>Anzahl pro Kategorie</label></span>
			</th>
	...
	<div class="media-blank">
		<p style="text-align:center"><input type="reset" class="button" value="Formular zur&uuml;cksetzen" /> &nbsp; <input type="button" class="button" id="searchbutton" value="Suchen" /></p>
	</div>
</form>
</td>
...
<legend>Widget-Parameter</legend>
	<table class="describe" style="border-top: none"><tbody>
		...
		<tr>
			<th valign="top" scope="row" class="label">
				<span class="alignleft"><label>Warenkorb URL</label></span>
			</th>
...
<div id="result">
<ul>
<li><a href="#book"><span>B&uuml;cher</span></a></li>
<li><a href="#audio"><span>H&ouml;rb&uuml;cher</span></a></li>
</ul>
